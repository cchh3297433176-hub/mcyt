    ...
    const USER_GUIDE_REGISTRY = {
        ...
        apps: [
            ...
            },
            {
                ...
                howToUse: "打开后底部有三个切换标签：「微信」标签下可与官方或自建 NPC 私聊或建群畅聊，支持切换大号/小号身份发言，支持发送猪猪表情包，NPC 会记住你们的重要承诺与聊天记忆；该标签顶部右上角「+」号点开「添加新朋友」即可创建全新的自建角色（设定名字、地区、初始人设），已有的好友长按头像或点进对话后点昵称，能看到TA的名片，名片里点「角色人设档案」区域可随时重新编辑TA的详细人设文本；「动态」标签就是朋友圈——刷主播朋友们的图文日常、点赞评论互动，自己也能编辑发布带图动态，好友会根据内容前来互动回复；「我」标签是当前账号资料（大号/小号切换、注册小号）。"
            },
            {
                name: "朋友圈（动态）",
                code: "chat",
        ...
        // 允许助手安全带路的 App 动作白名单
        validAppCodes: ['theme', 'chat', 'youtube', 'ao3', 'streaming', 'story', 'shop', 'settings', 'backup', 'tarot']
    };
