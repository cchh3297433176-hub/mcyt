    ...
    const USER_GUIDE_REGISTRY = {
        ...
        apps: [
            ...
            },
            {
                name: "聊天中心",
                code: "chat",
                location: "桌面第一排第 1 个应用（唯一入口，聊天/朋友圈/联系人/角色创建编辑全部在这一个 App 里，桌面上单独的「朋友圈」「通讯录」图标目前还没接通，点了也没用，不要往那两个图标带路）",
                whatItDoes: "与 MC 主播及好友即时通讯、刷朋友圈动态、管理联系人、创建与编辑自建角色人设，四合一入口。",
                howToUse: "打开后底部有三个切换标签：「微信」标签下可与官方或自建 NPC 私聊或建群畅聊，支持切换大号/小号身份发言，支持发送猪猪表情包，NPC 会记住你们的重要承诺与聊天记忆；私聊界面左下角「+」号点开后有个【记忆设置】选项，可以针对这位好友单独打开「长效记忆」——保留最新多少条对话给TA直接看、聊满多少条自动把早期对话浓缩成TA的长期印象，这样TA才不会忘记你们很久以前聊过的事；该标签顶部右上角「+」号点开「添加新朋友」即可创建全新的自建角色（设定名字、地区、初始人设），已有的好友长按头像或点进对话后点昵称，能看到TA的名片，名片里点「角色人设档案」区域可随时重新编辑TA的详细人设文本；「动态」标签就是朋友圈——刷主播朋友们的图文日常、点赞评论互动，自己也能编辑发布带图动态，好友会根据内容前来互动回复；「我」标签是当前账号资料（大号/小号切换、注册小号）。"
            },
            {
                name: "忆海",
                code: "rememori",
                location: "桌面第一排第 2 个应用（原本「朋友圈」图标的位置，朋友圈现在收纳进「聊天中心」App底部的「动态」标签了）",
                whatItDoes: "独立的记忆中枢，帮你回顾和每一位角色之间发生过的重要对话、约定与故事片段，让角色真的记得你们之间发生过的事，不再是每次都从零开始的陌生对话。",
                howToUse: "打开后能看到每个角色各自的一条记忆胶囊，点开某个角色即可查看你和TA之间沉淀下来的具体记忆条目；平时聊天中比较重要的对话会在后台自动悄悄整理进这里，不需要手动做任何操作；里面也能配置AI接口相关的参数让记忆整理更准，一般不用玩家自己动手改。"
            },
            {
                name: "朋友圈（动态）",
                code: "chat",
                location: "不是独立桌面图标——打开「聊天中心」App 后，底部三个标签里的「动态」就是朋友圈，桌面上单独那个「朋友圈」图标目前还没接通，是空占位，不要带玩家去点它",
                whatItDoes: "主播日常生活圈与动态互动，实际就是聊天中心内嵌的一个标签页。",
                howToUse: "先用 [[GO_APP:chat]] 带玩家打开聊天中心，再告诉TA点底部「动态」标签：刷主播朋友们的图文日常，点赞评论互动；自己也可以编辑发布带图朋友圈，好友会根据你的内容前来互动回复。"
            },
            {
                name: "通讯录（联系人）",
                code: "chat",
                location: "不是独立桌面图标——打开「聊天中心」App 后，底部「微信」标签里就是联系人列表；桌面上单独那个「通讯录」图标目前还没接通，是空占位，不要带玩家去点它",
                whatItDoes: "查看已加好友名录、创建自建角色，实际都在聊天中心的「微信」标签里完成。",
                howToUse: "先用 [[GO_APP:chat]] 带玩家打开聊天中心，停在默认的「微信」标签即可看到所有好友列表（含五维属性与好感度阶段，点头像/昵称进名片查看）；点右上角「+」号选「添加新朋友」即可自建全新主播角色。"
            },
            {
                name: "油管视频",
                code: "youtube",
        ...
        // 允许助手安全带路的 App 动作白名单
        validAppCodes: ['theme', 'chat', 'youtube', 'ao3', 'streaming', 'story', 'shop', 'settings', 'backup', 'tarot', 'rememori']
    };
