...
(function(window) {
    ...
    const USER_GUIDE_REGISTRY = {
        ...
        desktopControls: [
            ...
            {
                name: "桌面各层手拖排版模式",
                location: "个性主题 App →「桌面小组件与位置分配」卡片内的「进入桌面排版模式」按钮",
                usage: "点进去之后，锁屏顶部条、塔罗组件、日历、待办便签、App 图标网格这五大块会各自被框选出来，手指按住其中任意一块直接整体上下拖拽，就能单独调整它离顶部的高低位置；屏幕侧边会出现一个小小的悬浮控制条，调好了点「保存」才会永久生效，不想要了点「重置」或者退回卡片里点「恢复默认」，就能一键清空所有微调、变回系统默认摆放。"
            },
            {
                name: "返回桌面横条",
        ...
        apps: [
            {
                ...
                howToUse: "从相册选图后按真机比例裁剪壁纸；下拉可自由调节状态栏、图标文字、主体核心草莓粉与纯白底色，全线接入正等边专业 HSV 色相盘与水滴吸色放大镜，支持一键重置默认色彩；可在「桌面小组件」里自由开启关闭日历与待办，并随意把它们分配在第 1 页或第 2 页；同一张卡片里还能进入「桌面各层手拖排版模式」，手指按住锁屏条、塔罗组件、日历、待办或App图标网格中的任意一块整体上下拖动微调高低位置，满意后点保存即可永久生效，也可随时一键恢复默认；内嵌免费商业字体大全外链，可导入本地字体或粘贴 HTML/CSS 全局更换手机字体。"
            },
            {
                name: "系统设置",
                code: "settings",
